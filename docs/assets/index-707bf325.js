...
const fireSprite = "" + new URL("Fire_Spreadsheet-18871d66.png", import.meta.url).href;
const cobblestone = "" + new URL("cobblestone2-6f1174d0.png", import.meta.url).href;
const bed = "" + new URL("bed-ef8f2918.png", import.meta.url).href;
...
const mainTheme = "" + new URL("ruapporangespace_Aim_To_Head_-_EMPeror_71070745-d21d0b12.mp3", import.meta.url).href;
const swordAttack = "" + new URL("Sword Whooshes Medium - QuickSounds.com-25f56e30.mp3", import.meta.url).href;
const steps = "" + new URL("sneaker-shoe-on-concrete-floor-fast-pace-1-www.FesliyanStudios.com-083addce.mp3", import.meta.url).href;
const evilSlime = "" + new URL("evil-slime-9c9658b5.mp3", import.meta.url).href;
const neutralSlime = "" + new URL("neutral-slime-12f3a47a.mp3", import.meta.url).href;
const movingSlime = "" + new URL("moving-slime-6c15fada.mp3", import.meta.url).href;
...
class CharacterGameObject extends GameObject {
  constructor(player, finiteStateMachine) {
    super(finiteStateMachine);
    __publicField(this, "player");
...
class QuestEntity extends Entity {
  ...
  initEntity() {
    ...
    this.closeStartModalFn = uiEntity.showModal({
      title: "Current Quest:",
      body: `О нет! Наша великая империя находится в упадке! Демоны нападают со всех сторон, культы предателей возникают то тут, то тамНам предстоит сделать выбор - мы герой или революционер. От нас зависит судьба империи - выберем ли мы разрушить её, либо отстроить из пепла и руин.Вы - независимый герой, способный на многое! Перед вами открывается путь приключений доселе не слыханной широты! Доколе мы - простые люди империидолжны страдать от гнёта короля-тирана. Пора навести порядок и восстановить справедливость! <br />  <br /> убейте 3х водных сламов и потушите ваш дом. Тогда империя восстановится.`
    });
...
class Game {
  constructor(canvas2, requestAnimationFrame, cancelAnimationFrame) {
